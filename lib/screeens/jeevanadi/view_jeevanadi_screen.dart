          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // TODO: Replace with actual donations list when available
                CommonList(
                  ...
                  SizedBox(
                    ...
                    child: ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                        value: (profileDetails.fillPercentage) / 100,
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: _buildFieldItem(
                      "Referred By",
                      '0 Members', // TODO: Add referred count when available
                    ),
                  ),
                  const SizedBox(width: 12),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: _buildFieldItem(
                      "Marital Status",
                      'N/A', // Not available in current model
                    ),
                  ),
                  const SizedBox(width: 12),
                  Expanded(
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildFieldItem(
                      "Address",
                      '${profileDetails.city ?? ''}, ${profileDetails.state ?? ''}, ${profileDetails.country ?? ''}'.trim(),
                    ),
                  ),
                ],
              ),
