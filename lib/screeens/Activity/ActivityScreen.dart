...
//           ? DateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").format(_selectedDate!.toUtc())
...
//             ScaffoldMessenger.of(context).showSnackBar(
//               SnackBar(
//                 content: Text(state.creationMessage ?? 'Activity created successfully'),
...
//             });
//           }
//           if (state.status == ActivityStatus.error && state.isCreating == false) {
//             ScaffoldMessenger.of(context).showSnackBar(
//               SnackBar(
//                 content: Text(state.errorMessage ?? 'Failed to create activity'),
//                 backgroundColor: Colors.red,
...
//                       // Jeevanadi Number
//                       TextFormField(
//                         controller: _jeevandiNoCtrl,
//                         keyboardType: TextInputType.number,
//                         decoration: InputDecoration(
//                           labelText: 'Jeevanadi Number',
//                           hintText: 'Enter Jeevanadi Number',
...
//                             return 'Jeevanadi Number is required';
//                           }
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Manual Jeevanaadi Number (fallback / manual entry)
                      // TextFormField(
                      //   controller: _jeevandiNoCtrl,
                      //   keyboardType: TextInputType.number,
                      //   decoration: InputDecoration(
                      //     labelText: 'Jeevanadi Number (or enter manually)',
                      //     hintText: 'Enter Jeevanadi Number',
